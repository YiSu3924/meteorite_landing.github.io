...
print(levene_test)
```
The result of Levene’s Test shows a p-value of $2.2 \times 10^{-16}$, which is far below 0.05. This indicates that the variances of mass across different continents are not equal. Given this result, we should proceed with Welch’s ANOVA instead of the standard ANOVA, as Welch’s ANOVA does not assume equal variances.
...
print(welch_anova)
```
$$F = 10.473, \quad \text{df}_1 = 7, \quad \text{df}_2 = 1304.2, \quad p\text{-value} = 7.472 \times 10^{-13}$$
